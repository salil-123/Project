...
\begin{itemize}
  ...
  \begin{itemize}\small
    ...
    \item WorldCover (effective): tree, shrubland, grassland, cropland, built-up, bare, water.
  \end{itemize}
...
\begin{itemize}
  ...
  \item It runs as a correction layer applied after the classifiers, not as retraining. This
  mirrors the idea of pixel-level error-correction layers in the regionally-accurate LULC work.
