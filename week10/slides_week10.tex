...
% ------------------------------------------------------------------
\begin{frame}{Segmenting the mining class (an interim)}
\begin{itemize}
...
\begin{itemize}\small
  ...
  water --- perennial bodies score high, monsoon-only ponds low. This is the seasonal-water signal the
...
together is hardest. That gap is the value --- it shows how much a single-site, single-year acacia
